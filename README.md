...
- Configure the delivery of platform components (defined in [d2-infra repository](https://github.com/izerecord/d2-infra)).
- Configure the delivery of applications (defined in [d2-apps repository](https://github.com/izerecord/d2-apps)).
...
The artifacts published to `oci://ghcr.io/izerecord/d2-fleet` are tagged as:
...
[FluxInstance](https://github.com/izerecord/d2-fleet/blob/main/clusters/staging/flux-system/flux-instance.yaml)
...
using the [ResourceSet](https://github.com/izerecord/d2-fleet/tree/main/tenants) definitions.

Each component is published to a dedicated OCI repository, for example, the `frontend` component
is published to `oci://ghcr.io/izerecord/d2-apps/frontend` and is tagged as:
...
for example, `flux tag oci://ghcr.io/izerecord/d2-apps/frontend:v1.2.3 --tag latest-stable`.
...
modifying the [FluxInstance](https://github.com/izerecord/d2-fleet/blob/main/clusters/staging/flux-system/flux-instance.yaml)
...
is available in the [terraform](https://github.com/izerecord/d2-fleet/tree/main/terraform) directory.

```shell
terraform apply \
  -var oci_token="${GITHUB_TOKEN}" \
  -var oci_url="oci://ghcr.io/izerecord/d2-fleet" \
  -var oci_tag="latest" \
...
- Creates a `FluxInstance` pointing to the `oci://ghcr.io/izerecord/d2-fleet` artifact.
...
[flux-system](https://github.com/izerecord/d2-fleet/tree/main/clusters/staging/flux-system)
directory.
...
[d2-infra repository](https://github.com/izerecord/d2-infra) and set the dependencies
